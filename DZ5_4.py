...
"""
Извлечение элемента dict 0.007270800000000577
Извлечение элемента ordered dict 0.012403800000000409
"""

"""
OrderedDict работает медленнее обычного, так как в python 3.6 и новее  обычный словарь запоминает
порядок добавления элементов поэтому, использование упорядоченного словаря
не имеет смысла.
"""
